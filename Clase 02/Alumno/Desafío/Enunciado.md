...
Por ejemplo si el usuario ingresa `male` y `16`, el mensaje debería ser `Sr. usted es menor de edad no puede ingresar`, si ingresa `male` y `34`el mensaje sería `Sra. usted es mayor de edad puede ingresar`.
