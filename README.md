# Curso de Desarrollador Programador Web - Camada 2935 💾
...
4. Entren al repositorio haciendo `cd programadorWeb-2935`. 
5. Luego ejecuten el comando `git remote add profe https://github.com/adrianc4/programadorWeb-2935` para vincular su repo con el mio.
